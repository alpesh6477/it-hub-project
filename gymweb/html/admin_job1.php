...
<div class="col-lg-9">
          <h2 class="r"> Job 1 Users</h2>
          <div class="search-bar" style="float:right; margin-right:15px;margin-bottom:15px;">
        <form class="search-form d-flex align-items-center" method="GET"  action="admin_job1.1.php">
    ...
    while($res = mysqli_fetch_assoc($data)){
        ...
        <th><a class = 'btn btn-dark' href='update_job1.php?id=".$res['id']."'>update</a></th>
<tr>";
