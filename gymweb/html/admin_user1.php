...
<div class="col-lg-9">
          <h2 class="r"> Our User</h2>
          <div class="search-bar" style="float:right;">
        <form class="search-form d-flex align-items-center" method="GET"  action="admin_user.php">
          <input  id="srchbar" type="text" name="query" placeholder="search" title="Enter search keyword">
          <button id="srchbtn" type="submit" title="Search">search </button>
        </form>
        </div>
    ...
    <?php
    $result1 ="SELECT * FROM user where name = '$query'";
  
    $data = mysqli_query($conn, $result1);
    ...
    while($res = mysqli_fetch_assoc($data)){
        ...
        <th><a class = 'btn btn-dark' href='update_user.php?id=".$res['id']."'>update</a></th>
<tr>";
