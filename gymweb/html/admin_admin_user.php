...
<a class="v" href="admin_user.php"> <p>User</p>  </a>
 ...
 <a class="btn btn-danger vivek" href="admin_login.php" > Log Out  </a>
...
<div class="col-lg-9">
          <h2 class="r"> Our admin</h2>
          <a href="admin_adduser.php" class="btn btn-dark">Add admin</a>
          <div class="search-bar" style="float:right; margin-right:15px;margin-bottom:15px;">
        <form class="search-form d-flex align-items-center" method="GET"  action="admin_user1.php">
    ...
    while($res = mysqli_fetch_assoc($data)){
        ...
        <th><a class = 'btn btn-dark' href='update_admin.php?id=".$res['id']."'>update</a></th>
<tr>";
