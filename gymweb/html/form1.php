...
<h2>Apply for a Job</h2>
    ...
    if(isset($_POST['Submit'])){
        ...
        $query ="INSERT INTO job1(name,address,dob,mobile,email,qualification,experience,skill,time) VALUES('$name','$address','$dob','$mobile','$email','$qualifications','$experience','$skills','$job_time')" ;
