...
<?php 
$id=$_GET['id'];
$query="SELECT * FROM job2 WHERE id=$id";
...
<h2>Update Application for a Job</h2>
    ...
    if(isset($_POST['Submit'])){
        ...
        $query ="UPDATE job2 SET name='$name',address='$address',dob='$dob',mobile='$mobile',email='$email',qualification='$qualifications',experience='$experience',skill='$skills',time='$job_time',status='$status' , date = '$date', joining_date = '$joining_date'  WHERE id = $id" ;
        $data = mysqli_query($conn,$query);
